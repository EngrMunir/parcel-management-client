    ...
    return (
        <div>
            <div className="mx-auto md:w-1/2">
                ...
                <form>
                    <input type="text" placeholder="Your Name" className="border w-full mb-4 py-2 px-4" />
                    <br />
                    <input type="text" placeholder="Photo URL" className="border w-full mb-4 py-2 px-4"/>
                    <br />
